...
describe Atm do
  let(:account) {instance_double('Account',pin_code:'1234', exp_date: '04/20',account_stautus: :active) }
  before do
  ...
  it 'reject withdraw if card is expired' do
    ...
    expected_output = { status: false, massage: 'card expired', date: Date.today }
